...
public class DBhelper {
    /**
     * Decalre the table name and all the attributes name , Create the the Table  If Not
     */
...
//    Getting the Employee Details
    public Employee getEmpDetails() throws SQLException {
